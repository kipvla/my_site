...
var app = (function () {
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$b, 48, 8, 1069);
    			attr_dev(div0, "class", "carousel-item active svelte-lzx4dd");
    			add_location(div0, file$b, 47, 6, 1026);
    			...
    			add_location(img1, file$b, 51, 8, 1202);
    			attr_dev(div1, "class", "carousel-item svelte-lzx4dd");
    			add_location(div1, file$b, 50, 6, 1166);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$c, 61, 8, 1949);
    			if (source.src !== (source_src_value = "sounds/STE-027.mp3")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "audio/mp3");
    			add_location(source, file$c, 80, 14, 3033);
    			audio.controls = true;
    			add_location(audio, file$c, 79, 12, 3002);
    			attr_dev(div0, "class", "color");
    			add_location(div0, file$c, 78, 10, 2970);
    			attr_dev(figure, "class", "mb-3");
    			add_location(figure, file$c, 75, 8, 2819);
    			add_location(p1, file$c, 85, 8, 3151);
    			...
    			add_location(a0, file$c, 98, 8, 3960);
    			add_location(p2, file$c, 103, 8, 4156);
    			attr_dev(a1, "class", "mb-3");
    			attr_dev(a1, "href", "https://rediscoveringmusician.wordpress.com/");
    			add_location(a1, file$c, 113, 8, 4749);
    			add_location(p3, file$c, 118, 8, 4883);
    			add_location(p4, file$c, 133, 8, 5749);
    			attr_dev(div1, "class", "col-3");
    			add_location(div1, file$c, 148, 14, 6488);
    			attr_dev(iframe, "class", "resp-iframe");
    			attr_dev(iframe, "title", "Gribby");
    			if (iframe.src !== (iframe_src_value = "https://www.youtube.com/embed/pN1ZA6hWd3s")) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");
    			iframe.allowFullscreen = true;
    			add_location(iframe, file$c, 151, 18, 6616);
    			attr_dev(div2, "class", "videos shadow");
    			add_location(div2, file$c, 150, 16, 6570);
    			attr_dev(div3, "class", "col-12 col-md-6");
    			add_location(div3, file$c, 149, 14, 6524);
    			attr_dev(div4, "class", "col-3");
    			add_location(div4, file$c, 160, 14, 7017);
    			attr_dev(div5, "class", "row");
    			add_location(div5, file$c, 147, 12, 6456);
    			attr_dev(div6, "class", "container");
    			add_location(div6, file$c, 146, 10, 6420);
    			attr_dev(div7, "class", "video mb-3");
    			add_location(div7, file$c, 145, 8, 6385);
    			add_location(p5, file$c, 165, 8, 7099);
    			add_location(p6, file$c, 172, 8, 7415);
    			add_location(p7, file$c, 186, 8, 7937);
    			add_location(p8, file$c, 194, 8, 8281);
    			attr_dev(a2, "href", "kip.riecken@gmail.com");
    			add_location(a2, file$c, 201, 8, 8596);
    			attr_dev(button0, "class", "btn");
    			attr_dev(button0, "href", "/contact");
    			add_location(button0, file$c, 202, 8, 8662);
    			attr_dev(button1, "class", "btn");
    			add_location(button1, file$c, 206, 8, 8765);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 35, 8, 663);
    			add_location(figcaption, file$c, 50, 10, 1566);
    			if (source.src !== (source_src_value = "sounds/STE-027.mp3")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "audio/mp3");
    			add_location(source, file$c, 54, 14, 1739);
    			audio.controls = true;
    			add_location(audio, file$c, 53, 12, 1708);
    			attr_dev(div, "class", "color");
    			add_location(div, file$c, 52, 10, 1676);
    			attr_dev(figure, "class", "mb-3");
    			add_location(figure, file$c, 49, 8, 1534);
    			attr_dev(button, "class", "btn");
    			add_location(button, file$c, 59, 8, 1857);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "m-5 rounded-circle shadow svelte-t0d8qy");
    			attr_dev(img, "id", "top-pic");
    			attr_dev(img, "alt", "Me");
    			add_location(img, file$c, 25, 6, 439);
    			attr_dev(div0, "class", "row bio-text text-justify clearfix p-3 d-flex flex-column justify-content-between");
    			add_location(div0, file$c, 23, 4, 331);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$c, 22, 2, 303);
    			attr_dev(div2, "class", "bio");
    			add_location(div2, file$c, 21, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Modal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { imgSrc: 0 });
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$g, 12, 2, 362);
    			attr_dev(div, "class", "container d-flex justify-content-center");
    			add_location(div, file$g, 11, 0, 306);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Link extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$k, create_fragment$k, safe_not_equal, { to: 6, replace: 7, state: 8, getProps: 9 });
    ...
    function create_fragment$m(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr, file$j, 1, 2, 26);
    			attr_dev(i0, "class", "nav-link fab fa-instagram");
    			add_location(i0, file$j, 4, 42, 121);
    			attr_dev(a0, "href", "https://www.instagram.com");
    			add_location(a0, file$j, 4, 6, 85);
    			attr_dev(i1, "class", "nav-link fab fa-facebook-square");
    			add_location(i1, file$j, 6, 41, 216);
    			attr_dev(a1, "href", "https://www.facebook.com");
    			add_location(a1, file$j, 6, 6, 181);
    			attr_dev(i2, "class", "nav-link fab fa-twitter");
    			add_location(i2, file$j, 8, 40, 316);
    			attr_dev(a2, "href", "https://www.twitter.com");
    			add_location(a2, file$j, 8, 6, 282);
    			attr_dev(div0, "class", "social");
    			add_location(div0, file$j, 3, 4, 58);
    			add_location(br, file$j, 11, 4, 411);
    			attr_dev(div1, "class", "footer");
    			add_location(div1, file$j, 2, 2, 33);
    			attr_dev(div2, "class", "container");
