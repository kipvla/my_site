...
var app = (function () {
    ...
    const file$3 = "src/components/Blog/Posts/Post1.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 15, 2, 420);
    			if (img.src !== (img_src_value = "/images/kangaroo.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "w-50 m-5 shadow");
    			attr_dev(img, "alt", "");
    			add_location(img, file$3, 16, 2, 447);
    			add_location(p0, file$3, 17, 2, 516);
    			add_location(p1, file$3, 21, 2, 650);
    			add_location(p2, file$3, 22, 2, 671);
    			add_location(strong, file$3, 30, 39, 1085);
    			add_location(p3, file$3, 27, 2, 886);
    			add_location(p4, file$3, 36, 2, 1376);
    			add_location(p5, file$3, 40, 2, 1541);
    			add_location(p6, file$3, 47, 2, 1928);
    			add_location(p7, file$3, 48, 2, 2007);
    			add_location(p8, file$3, 52, 2, 2144);
    			add_location(p9, file$3, 56, 2, 2299);
    			add_location(p10, file$3, 61, 2, 2532);
    			add_location(li0, file$3, 64, 4, 2619);
    			add_location(li1, file$3, 65, 4, 2659);
    			add_location(li2, file$3, 66, 4, 2704);
    			add_location(li3, file$3, 67, 4, 2743);
    			add_location(ul, file$3, 63, 2, 2610);
    			add_location(p11, file$3, 69, 2, 2790);
    			attr_dev(a, "href", "/blog");
    			attr_dev(a, "class", "btn");
    			add_location(a, file$3, 73, 2, 2956);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "More";
    			add_location(h1, file$3, 7, 2, 139);
    			if (img.src !== (img_src_value = "/images/kangaroo.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "w-50 m-5 shadow");
    			attr_dev(img, "alt", "");
    			add_location(img, file$3, 8, 2, 166);
    			add_location(p, file$3, 9, 2, 235);
    			attr_dev(a, "href", "/blog/1");
    			attr_dev(a, "class", "btn");
    			add_location(a, file$3, 13, 2, 369);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*short*/ ctx[0]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 5, 0, 61);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Post1> was created with unknown prop '${key}'`);
    	});
    ...
    class Post1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { short: 0 });
    		...
    		if (/*short*/ ctx[0] === undefined && !("short" in props)) {
    			console_1.warn("<Post1> was created without expected prop 'short'");
    		}
    	}
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Blogs> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 6, 2, 149);
    			attr_dev(div1, "class", "content svelte-uhes0j");
    			add_location(div1, file$4, 5, 0, 125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 4, 2, 153);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file$5, 11, 6, 327);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "name", "name");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "placeholder", "Name");
    			add_location(input0, file$5, 12, 6, 372);
    			attr_dev(div0, "class", "form-group");
    			add_location(div0, file$5, 10, 4, 296);
    			attr_dev(label1, "for", "_replyto");
    			add_location(label1, file$5, 15, 6, 501);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "_replyto");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "Email");
    			add_location(input1, file$5, 16, 6, 551);
    			attr_dev(div1, "class", "form-group");
    			add_location(div1, file$5, 14, 4, 470);
    			attr_dev(label2, "for", "");
    			add_location(label2, file$5, 19, 6, 675);
    			attr_dev(textarea, "name", "message");
    			attr_dev(textarea, "rows", "8");
    			attr_dev(textarea, "class", "form-control svelte-1l0srdu");
    			attr_dev(textarea, "placeholder", "Message");
    			add_location(textarea, file$5, 21, 6, 717);
    			attr_dev(div2, "class", "form-group");
    			add_location(div2, file$5, 18, 4, 644);
    			attr_dev(input2, "type", "submit");
    			attr_dev(input2, "class", "btn");
    			input2.value = "Submit";
    			add_location(input2, file$5, 23, 4, 811);
    			attr_dev(input3, "type", "hidden");
    			attr_dev(input3, "name", "_next");
    			input3.value = "//site.io/thanks.html";
    			add_location(input3, file$5, 24, 4, 866);
    			attr_dev(form, "action", "https://formspree.io/f/xpzolpwz");
    			attr_dev(form, "class", "text-left");
    			attr_dev(form, "method", "POST");
    			add_location(form, file$5, 5, 2, 197);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$7, 14, 8, 585);
    			add_location(li1, file$7, 15, 8, 640);
    			add_location(li2, file$7, 16, 8, 696);
    			add_location(li3, file$7, 17, 8, 774);
    			add_location(ul, file$7, 13, 6, 572);
    			add_location(div0, file$7, 6, 4, 184);
    			add_location(h30, file$7, 22, 8, 931);
    			add_location(h50, file$7, 23, 8, 961);
    			add_location(p1, file$7, 24, 8, 995);
    			attr_dev(div1, "class", "lesson-type");
    			add_location(div1, file$7, 21, 6, 897);
    			add_location(h31, file$7, 27, 8, 1054);
    			add_location(h51, file$7, 28, 8, 1085);
    			add_location(p2, file$7, 29, 8, 1119);
    			attr_dev(div2, "class", "lesson-type");
    			add_location(div2, file$7, 26, 6, 1020);
    			add_location(h32, file$7, 32, 8, 1178);
    			add_location(h52, file$7, 33, 8, 1231);
    			add_location(p3, file$7, 34, 8, 1265);
    			attr_dev(div3, "class", "lesson-type");
    			add_location(div3, file$7, 31, 6, 1144);
    			attr_dev(div4, "class", "container text-left pt-4");
    			add_location(div4, file$7, 20, 4, 852);
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$9, 54, 8, 1151);
    			attr_dev(div0, "class", "carousel-item active svelte-18n2ijv");
    			add_location(div0, file$9, 53, 6, 1108);
    			...
    			add_location(img1, file$9, 57, 8, 1284);
    			attr_dev(div1, "class", "carousel-item svelte-18n2ijv");
    			add_location(div1, file$9, 56, 6, 1248);
    			...
    			add_location(div4, file$9, 46, 0, 689);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$a, 76, 8, 2166);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	let if_block5 = /*teaching*/ ctx[4] && create_if_block_1(ctx);
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$a, 94, 10, 2617);
    			...
    			add_location(a, file$a, 110, 10, 3151);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			attr_dev(p, "class", "svelte-41qe4r");
    			add_location(p, file$a, 169, 12, 5832);
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$a, 182, 12, 6494);
    			attr_dev(div0, "class", "col-3");
    			add_location(div0, file$a, 187, 18, 6688);
    			attr_dev(iframe, "class", "resp-iframe");
    			attr_dev(iframe, "title", "Gribby");
    			if (iframe.src !== (iframe_src_value = "https://www.youtube.com/embed/pN1ZA6hWd3s")) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");
    			iframe.allowFullscreen = true;
    			add_location(iframe, file$a, 190, 22, 6828);
    			attr_dev(div1, "class", "videos shadow");
    			add_location(div1, file$a, 189, 20, 6778);
    			attr_dev(div2, "class", "col-12 col-md-6");
    			add_location(div2, file$a, 188, 18, 6728);
    			attr_dev(div3, "class", "col-3");
    			add_location(div3, file$a, 200, 18, 7287);
    			attr_dev(div4, "class", "row");
    			add_location(div4, file$a, 186, 16, 6652);
    			attr_dev(div5, "class", "container");
    			add_location(div5, file$a, 185, 14, 6612);
    			attr_dev(div6, "class", "video mb-3");
    			add_location(div6, file$a, 184, 12, 6573);
    			add_location(div7, file$a, 168, 10, 5777);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$a, 219, 21, 7950);
    			attr_dev(p, "class", "svelte-41qe4r");
    			add_location(p, file$a, 215, 10, 7651);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-41qe4r");
    			add_location(p, file$a, 233, 10, 8442);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			current = true;
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "svelte-41qe4r");
    			add_location(p0, file$a, 248, 10, 8886);
    			attr_dev(p1, "class", "svelte-41qe4r");
    			add_location(p1, file$a, 257, 10, 9267);
    			attr_dev(button0, "class", "btn");
    			attr_dev(button0, "href", "/lessons");
    			add_location(button0, file$a, 265, 10, 9699);
    			attr_dev(p2, "class", "svelte-41qe4r");
    			add_location(p2, file$a, 267, 10, 9763);
    			attr_dev(button1, "class", "btn");
    			attr_dev(button1, "href", "/contact");
    			add_location(button1, file$a, 273, 10, 10029);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t0, anchor);
    			insert_dev(target, p0, anchor);
    ...
    function create_fragment$c(ctx) {
    	...
    	let if_block1 = /*more*/ ctx[1] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$a, 46, 4, 1103);
    			...
    			attr_dev(img, "alt", "Me");
    			add_location(img, file$a, 50, 6, 1276);
    			add_location(figcaption, file$a, 58, 8, 1427);
    			if (source.src !== (source_src_value = "sounds/STE-027.mp3")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "audio/mp3");
    			add_location(source, file$a, 62, 12, 1592);
    			audio.controls = true;
    			add_location(audio, file$a, 61, 10, 1563);
    			attr_dev(div0, "class", "color");
    			add_location(div0, file$a, 60, 8, 1533);
    			attr_dev(figure, "class", "mb-3");
    			add_location(figure, file$a, 57, 6, 1397);
    			attr_dev(p, "class", "svelte-41qe4r");
    			add_location(p, file$a, 67, 6, 1702);
    			attr_dev(div1, "class", "bio-text text-justify clearfix p-3 d-flex flex-column justify-content-between svelte-41qe4r");
    			add_location(div1, file$a, 47, 4, 1167);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$a, 44, 2, 1033);
    			attr_dev(div3, "class", "bio d-flex");
    			add_location(div3, file$a, 43, 0, 1006);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$k($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<BlogPost> was created with unknown prop '${key}'`);
    	});
    ...
    class BlogPost extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*Title*/ ctx[0] === undefined && !("Title" in props)) {
    			console_1$2.warn("<BlogPost> was created without expected prop 'Title'");
    		}

    		if (/*ID*/ ctx[1] === undefined && !("ID" in props)) {
    			console_1$2.warn("<BlogPost> was created without expected prop 'ID'");
    		}

    		if (/*Image*/ ctx[2] === undefined && !("Image" in props)) {
    			console_1$2.warn("<BlogPost> was created without expected prop 'Image'");
    		}

    		if (/*Body*/ ctx[3] === undefined && !("Body" in props)) {
    			console_1$2.warn("<BlogPost> was created without expected prop 'Body'");
    		}

    		if (/*Date*/ ctx[4] === undefined && !("Date" in props)) {
    			console_1$2.warn("<BlogPost> was created without expected prop 'Date'");
    		}
    	}
    ...
    function instance$l($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<SinglePost> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$m(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$i, 21, 12, 703);
    			attr_dev(span1, "class", "svelte-1b6e3xj");
    			add_location(span1, file$i, 20, 16, 684);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "navbar-link-brand font-weight-light svelte-1b6e3xj");
    			add_location(a0, file$i, 19, 4, 612);
    			attr_dev(span2, "class", "icon-bar top-bar svelte-1b6e3xj");
    			add_location(span2, file$i, 28, 6, 886);
    			attr_dev(span3, "class", "icon-bar middle-bar svelte-1b6e3xj");
    			add_location(span3, file$i, 29, 6, 926);
    			attr_dev(span4, "class", "icon-bar bottom-bar svelte-1b6e3xj");
    			add_location(span4, file$i, 30, 6, 969);
    			attr_dev(span5, "class", "sr-only");
    			add_location(span5, file$i, 31, 6, 1012);
    			attr_dev(button, "class", "navbar-toggler navbar-toggler-right svelte-1b6e3xj");
    			attr_dev(button, "type", "button");
    			add_location(button, file$i, 24, 4, 772);
    			attr_dev(div0, "class", "d-flex justify-content-between");
    			add_location(div0, file$i, 18, 2, 563);
    			attr_dev(a1, "href", "/about");
    			attr_dev(a1, "class", "nav-link font-weight-light");
    			add_location(a1, file$i, 37, 4, 1219);
    			attr_dev(a2, "href", "/lessons");
    			attr_dev(a2, "class", "nav-link");
    			add_location(a2, file$i, 38, 4, 1317);
    			attr_dev(a3, "href", "/blog");
    			attr_dev(a3, "class", "nav-link");
    			add_location(a3, file$i, 39, 4, 1401);
    			attr_dev(a4, "href", "/contact");
    			attr_dev(a4, "class", "nav-link");
    			add_location(a4, file$i, 40, 4, 1479);
    			attr_dev(nav, "class", "navbar-items svelte-1b6e3xj");
    			attr_dev(nav, "id", "navbarResponsive");
    			add_location(nav, file$i, 36, 2, 1166);
    			attr_dev(div1, "id", "mainNavbar");
    			attr_dev(div1, "class", "navbar fixed-top svelte-1b6e3xj");
    			add_location(div1, file$i, 17, 0, 514);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$m($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ link, onMount, classToggle });
    	return [];
    }
