    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$b, 76, 8, 2166);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$b, 46, 4, 1103);
    			...
    			attr_dev(img, "alt", "Me");
    			add_location(img, file$b, 50, 6, 1276);
    			add_location(figcaption, file$b, 58, 8, 1427);
    			if (source.src !== (source_src_value = "sounds/STE-027.mp3")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "audio/mp3");
    			add_location(source, file$b, 62, 12, 1592);
    			audio.controls = true;
    			add_location(audio, file$b, 61, 10, 1563);
    			attr_dev(div0, "class", "color");
    			add_location(div0, file$b, 60, 8, 1533);
    			attr_dev(figure, "class", "mb-3");
    			add_location(figure, file$b, 57, 6, 1397);
    			attr_dev(p, "class", "svelte-41qe4r");
    			add_location(p, file$b, 67, 6, 1702);
    			attr_dev(div1, "class", "bio-text text-justify clearfix p-3 d-flex flex-column justify-content-between svelte-41qe4r");
    			add_location(div1, file$b, 47, 4, 1167);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$b, 44, 2, 1033);
    			attr_dev(div3, "class", "bio d-flex");
    			add_location(div3, file$b, 43, 0, 1006);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
