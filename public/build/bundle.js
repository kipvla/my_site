    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = space();
    			p7 = element("p");
    			p7.textContent = "Giving yourself a chance to release the neck is to practice a skill you\n      may find coming in handy in many instances.";
    			t20 = space();
    			p8 = element("p");
    			...
    			t34 = space();
    			p11 = element("p");
    			p11.textContent = "Practicing this lie down, and learning AT, can help in ways that you may\n      not have expected. And it can all just start with this simple practice.";
    			t36 = space();
    			a = element("a");
    			a.textContent = "Back to blogs";
    			add_location(h1, file$4, 15, 4, 483);
    			if (img.src !== (img_src_value = "/images/kangaroo.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "w-50 m-5 shadow");
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 16, 4, 512);
    			add_location(p0, file$4, 17, 4, 583);
    			add_location(p1, file$4, 21, 4, 725);
    			add_location(p2, file$4, 22, 4, 748);
    			add_location(strong, file$4, 30, 44, 1178);
    			add_location(p3, file$4, 27, 4, 973);
    			add_location(p4, file$4, 36, 4, 1481);
    			add_location(p5, file$4, 40, 4, 1654);
    			add_location(p6, file$4, 47, 4, 2055);
    			add_location(p7, file$4, 48, 4, 2136);
    			add_location(p8, file$4, 52, 4, 2281);
    			add_location(p9, file$4, 56, 4, 2444);
    			add_location(p10, file$4, 61, 4, 2687);
    			add_location(li0, file$4, 64, 6, 2778);
    			add_location(li1, file$4, 65, 6, 2820);
    			add_location(li2, file$4, 66, 6, 2867);
    			add_location(li3, file$4, 67, 6, 2908);
    			add_location(ul, file$4, 63, 4, 2767);
    			add_location(p11, file$4, 69, 4, 2959);
    			attr_dev(a, "href", "/blog");
    			attr_dev(a, "class", "btn");
    			add_location(a, file$4, 73, 4, 3133);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "More";
    			add_location(h1, file$4, 7, 4, 161);
    			if (img.src !== (img_src_value = "/images/kangaroo.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "w-50 m-5 shadow");
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 8, 4, 190);
    			attr_dev(p, "class", "my-5");
    			add_location(p, file$4, 9, 4, 261);
    			attr_dev(a, "href", "/blog/1");
    			attr_dev(a, "class", "btn mb-5");
    			add_location(a, file$4, 13, 4, 416);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 5, 0, 81);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$8, 10, 6, 201);
    			add_location(p0, file$8, 14, 6, 326);
    			add_location(li0, file$8, 21, 8, 621);
    			add_location(li1, file$8, 22, 8, 676);
    			add_location(li2, file$8, 23, 8, 732);
    			add_location(li3, file$8, 24, 8, 810);
    			add_location(ul, file$8, 20, 6, 608);
    			add_location(div0, file$8, 9, 4, 189);
    			add_location(h30, file$8, 29, 8, 967);
    			add_location(h50, file$8, 30, 8, 997);
    			add_location(p1, file$8, 31, 8, 1031);
    			attr_dev(div1, "class", "lesson-type");
    			add_location(div1, file$8, 28, 6, 933);
    			add_location(h31, file$8, 34, 8, 1090);
    			add_location(h51, file$8, 35, 8, 1121);
    			add_location(p2, file$8, 36, 8, 1155);
    			attr_dev(div2, "class", "lesson-type");
    			add_location(div2, file$8, 33, 6, 1056);
    			add_location(h32, file$8, 39, 8, 1214);
    			add_location(h52, file$8, 40, 8, 1267);
    			add_location(p3, file$8, 41, 8, 1301);
    			attr_dev(div3, "class", "lesson-type");
    			add_location(div3, file$8, 38, 6, 1180);
    			attr_dev(div4, "class", "container text-left pt-4");
    			add_location(div4, file$8, 27, 4, 888);
    			attr_dev(div5, "class", "lesson-option");
    			add_location(div5, file$8, 8, 2, 157);
    		...
    		i: function intro(local) {
    			if (!div6_intro) {
    				add_render_callback(() => {
    					div6_intro = create_in_transition(div6, fly, { x: 50, delay: 1000, duration: 4000 });
    					div6_intro.start();
    				});
    			}
    		},
