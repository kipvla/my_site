    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$c, 59, 8, 1877);
    			add_location(figcaption, file$c, 74, 10, 2779);
    			if (source.src !== (source_src_value = "sounds/STE-027.mp3")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "audio/mp3");
    			add_location(source, file$c, 78, 14, 2952);
    			audio.controls = true;
    			add_location(audio, file$c, 77, 12, 2921);
    			attr_dev(div0, "class", "color");
    			add_location(div0, file$c, 76, 10, 2889);
    			attr_dev(figure, "class", "mb-3");
    			add_location(figure, file$c, 73, 8, 2747);
    			add_location(p1, file$c, 83, 8, 3070);
    			...
    			add_location(a0, file$c, 96, 8, 3879);
    			add_location(p2, file$c, 101, 8, 4075);
    			attr_dev(a1, "class", "mb-3");
    			attr_dev(a1, "href", "https://rediscoveringmusician.wordpress.com/");
    			add_location(a1, file$c, 111, 8, 4668);
    			add_location(p3, file$c, 116, 8, 4802);
    			add_location(p4, file$c, 131, 8, 5668);
    			attr_dev(div1, "class", "col-3");
    			add_location(div1, file$c, 146, 14, 6407);
    			attr_dev(iframe, "class", "resp-iframe");
    			attr_dev(iframe, "title", "Gribby");
    			if (iframe.src !== (iframe_src_value = "https://www.youtube.com/embed/pN1ZA6hWd3s")) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");
    			iframe.allowFullscreen = true;
    			add_location(iframe, file$c, 149, 18, 6535);
    			attr_dev(div2, "class", "videos shadow");
    			add_location(div2, file$c, 148, 16, 6489);
    			attr_dev(div3, "class", "col-12 col-md-6");
    			add_location(div3, file$c, 147, 14, 6443);
    			attr_dev(div4, "class", "col-3");
    			add_location(div4, file$c, 158, 14, 6936);
    			attr_dev(div5, "class", "row");
    			add_location(div5, file$c, 145, 12, 6375);
    			attr_dev(div6, "class", "container");
    			add_location(div6, file$c, 144, 10, 6339);
    			attr_dev(div7, "class", "video mb-3");
    			add_location(div7, file$c, 143, 8, 6304);
    			add_location(p5, file$c, 163, 8, 7018);
    			add_location(p6, file$c, 170, 8, 7334);
    			add_location(p7, file$c, 184, 8, 7856);
    			add_location(p8, file$c, 192, 8, 8200);
    			attr_dev(a2, "href", "kip.riecken@gmail.com");
    			add_location(a2, file$c, 199, 8, 8515);
    			attr_dev(button0, "class", "btn");
    			attr_dev(button0, "href", "/contact");
    			add_location(button0, file$c, 200, 8, 8581);
    			attr_dev(button1, "class", "btn");
    			add_location(button1, file$c, 204, 8, 8684);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 33, 8, 591);
    			add_location(figcaption, file$c, 48, 10, 1494);
    			if (source.src !== (source_src_value = "sounds/STE-027.mp3")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "audio/mp3");
    			add_location(source, file$c, 52, 14, 1667);
    			audio.controls = true;
    			add_location(audio, file$c, 51, 12, 1636);
    			attr_dev(div, "class", "color");
    			add_location(div, file$c, 50, 10, 1604);
    			attr_dev(figure, "class", "mb-3");
    			add_location(figure, file$c, 47, 8, 1462);
    			attr_dev(button, "class", "btn");
    			add_location(button, file$c, 57, 8, 1785);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			insert_dev(target, t1, anchor);
